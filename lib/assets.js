...
function styles(options) {
  if (assetCache.css) return assetCache.css;

  if (compress || options.compress) {
    assetCache.css = '<link href="/css/compiled/'+CSS_HASH+'.css" rel="stylesheet" type="text/css"/>';
  }
  else {
...
function scripts(options) {
  if (assetCache.js) return assetCache.js;
